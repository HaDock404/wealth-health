            ...
            <table id="employee-table" className="display dataTable no-footer" role="grid">
                <thead>
                    <tr role="row">
                        ...
                        <th className="sorting" tabIndex="0" aria-controls="employee-table" rowSpan="1" colSpan="1" aria-label="Street: activate to sort column ascending" style={{width: "40.5781px"}}>Street</th>
                        <th className="sorting" tabIndex="0" aria-controls="employee-table" rowSpan="1" colSpan="1" aria-label="City: activate to sort column ascending" style={{width: "29.3281px"}}>City</th>
                        <th className="sorting" tabIndex="0" aria-controls="employee-table" rowSpan="1" colSpan="1" aria-label="State: activate to sort column ascending" style={{width: "34.6562px"}}>State</th>
                        <th className="sorting" tabIndex="0" aria-controls="employee-table" rowSpan="1" colSpan="1" aria-label="Zip Code: activate to sort column ascending" style={{width: "63.5781px"}}>Zip Code</th>
                    </tr>
                </thead>
                <tbody>
